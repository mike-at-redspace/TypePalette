...
export const generateProseConfig = config => {
  ...
  // Get element-specific heading configs
  const headingElements = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6']
  const headingElementConfigs = {}
  headingElements.forEach(element => {
    headingElementConfigs[element] = config.headings?.[element] || headingConfig
  })
...
/* Comprehensive Typography Overrides - Uses standard CSS variables for full control */
/* Headings - Standalone and Prose */
${headingElements
  .map(element => {
    return `${element} {
  font-family: var(--font-heading-${element}, var(--font-heading));
  font-weight: var(--heading-${element}-weight, var(--heading-weight));
  letter-spacing: var(--heading-${element}-tracking, var(--heading-tracking));
  line-height: var(--heading-${element}-leading, var(--heading-leading));
  text-transform: var(--heading-${element}-transform, var(--heading-transform));
}
.prose ${element},
.prose.prose-invert ${element} {
  font-family: var(--font-heading-${element}, var(--font-heading));
  font-weight: var(--heading-${element}-weight, var(--heading-weight));
  letter-spacing: var(--heading-${element}-tracking, var(--heading-tracking));
  line-height: var(--heading-${element}-leading, var(--heading-leading));
...
/* Body Elements - Standalone and Prose */
/* Paragraphs */
p {
  font-family: var(--font-body-paragraph, var(--font-body));
  font-weight: var(--body-paragraph-weight, var(--body-weight));
  letter-spacing: var(--body-paragraph-tracking, var(--body-tracking));
  line-height: var(--body-paragraph-leading, var(--body-leading));
  text-transform: var(--body-paragraph-transform, var(--body-transform));
}
.prose p,
...
strong {
  ...
  letter-spacing: var(--body-strong-tracking, var(--body-tracking));
  line-height: var(--body-strong-leading, var(--body-leading));
  text-transform: var(--body-strong-transform, var(--body-transform));
}
.prose strong,
...
em {
  ...
  letter-spacing: var(--body-emphasis-tracking, var(--body-tracking));
  line-height: var(--body-emphasis-leading, var(--body-leading));
  text-transform: var(--body-emphasis-transform, var(--body-transform));
}
.prose em,
...
code {
  ...
  letter-spacing: var(--body-code-tracking, var(--body-tracking));
  line-height: var(--body-code-leading, var(--body-leading));
  text-transform: var(--body-code-transform, var(--body-transform));
}
pre code {
  font-family: var(--font-body-code, var(--font-body));
  font-weight: var(--body-code-weight, var(--body-weight));
...
a {
  ...
  letter-spacing: var(--body-link-tracking, var(--body-tracking));
  line-height: var(--body-link-leading, var(--body-leading));
  text-transform: var(--body-link-transform, var(--body-transform));
}
.prose a,
...
blockquote {
  ...
  letter-spacing: var(--body-blockquote-tracking, var(--body-tracking));
  line-height: var(--body-blockquote-leading, var(--body-leading));
  text-transform: var(--body-blockquote-transform, var(--body-transform));
}
.prose blockquote,
 ...
 */
export const generateTypeScriptTypes = _config => {
  return `/**
 ...
 */
export const generateReactExamples = _config => {
  return `/**
...
export const generateKitchenSinkHTML = config => {
  ...
  // Generate comprehensive prose config for typography overrides
...
${cssVars
  ...
  <style>
      ...
      /* Typography overrides - Comprehensive styles from prose-config */
${proseConfig
  .split('/* Comprehensive Typography Overrides')[1] // Get everything after this comment
  .split('/* Usage in HTML')[0] // Stop before the usage comment
  .split('\n')
  .map(line => '      ' + line)
  .join('\n')}
